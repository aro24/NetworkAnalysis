...
public class FlowEdge {
    ...
    private final double capacity;   // capacity or bandwidth
    private double flow;             // flow
    private final int speed;
    private final double weight;
	private final int length;
    public static final int optical = 200000000;
    public static final int copper = 230000000;
     ...
     * Imma use this.
     */
    public FlowEdge(int v, int w, double capacity, int length, boolean type) {
        if (v < 0) throw new IllegalArgumentException("vertex index must be a non-negative integer");
        if (w < 0) throw new IllegalArgumentException("vertex index must be a non-negative integer");
        if (!(capacity >= 0.0)) throw new IllegalArgumentException("Edge capacity must be non-negative");
        this.v         = v;
		...
		this.weight=(double)this.length/(double)this.speed;
    }
