...
public class PrimMST {
    ...
    private FlowEdge[] edgeTo;        // edgeTo[v] = shortest edge from tree vertex to non-tree vertex
    ...
    private void prim(FlowNetwork G, int s) {
        distTo[s] = 0.0;
    ...
    // scan vertex v
    private void scan(FlowNetwork G, int v) {
        marked[v] = true;
    ...
    public Iterable<FlowEdge> edges() {
        Queue<FlowEdge> mst = new Queue<FlowEdge>();
    ...
    private boolean check(FlowNetwork G) {
